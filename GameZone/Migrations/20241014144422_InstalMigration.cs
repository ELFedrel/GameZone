...
{
    /// <inheritdoc />
    public partial class InstalMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "A unique integer, Primary Key")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublisherId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Publisher Id"),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    GenreId = table.Column<int>(type: "int", nullable: false, comment: "Genre Id"),
                    IsDeleated = table.Column<bool>(type: "bit", nullable: false, comment: "Is Deleated")
                },
                constraints: table =>
                {
